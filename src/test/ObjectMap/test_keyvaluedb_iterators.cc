...
class SinglePrefixIteratorTest : public IteratorTest
{
public:
  string prefix;
...
TEST_F(SinglePrefixIteratorTest, WholeSpaceIteratorRmKeys)
{
...
TEST_F(SinglePrefixIteratorTest, WholeSpaceSnapshotIteratorRmKeys)
{
  // test leveldb store
...
TEST_F(SinglePrefixIteratorTest, SnapshotIteratorUpdatesLevelDB)
{
  KeyValueDB::WholeSpaceIterator db_it = db->get_snapshot_iterator();
...
TEST_F(SinglePrefixIteratorTest, SnapshotIteratorUpdatesMockDB)
{
  KeyValueDB::WholeSpaceIterator mock_it = mock->get_snapshot_iterator();
...
TEST_F(SinglePrefixIteratorTest, IteratorUpdatesMockDB)
{
...
class TwoPrefixesIteratorTest : public IteratorTest
{
public:
  string prefix1;
  string prefix2;
...
TEST_F(TwoPrefixesIteratorTest, LowerBoundWholeSpaceIterator)
{
  // test leveldb
  KeyValueDB::WholeSpaceIterator db_it = db->get_iterator();
...
TEST_F(TwoPrefixesIteratorTest, UpperBoundWholeSpaceIterator)
{
  // test leveldb
  KeyValueDB::WholeSpaceIterator db_it = db->get_iterator();
...
TEST_F(TwoPrefixesIteratorTest, BackwardIterationLevelDB)
{
  // test leveldb store
  KeyValueDB::WholeSpaceIterator db_it = db->get_iterator();
  db_it->seek_to_last();
...
TEST_F(TwoPrefixesIteratorTest, BackwardIteratorMockDB)
{
  // test mock store
  KeyValueDB::WholeSpaceIterator mock_it = mock->get_iterator();
...
TEST_F(TwoPrefixesIteratorTest, PrefixBackwardIteratorMockDB)
{
  KeyValueDB::WholeSpaceIterator mock_it = mock->get_iterator();

  // test seek_to_last prefix2
  mock_it->seek_to_last(prefix2);
  ASSERT_TRUE(mock_it->valid());
  ASSERT_TRUE(validate_iterator(prefix2, "04", mock_it));
  ...
  // test seek_to_last prefix1
  mock_it->seek_to_last(prefix1);
...
TEST_F(TwoPrefixesIteratorTest, PrefixBackwardIteratorLevelDB)
{
  KeyValueDB::WholeSpaceIterator mock_it = mock->get_iterator();
